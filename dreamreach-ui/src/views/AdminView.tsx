                ...
                <div className="panel">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '30px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '10px', background: 'var(--surface-2)', padding: '15px', borderRadius: '6px', border: '1px solid var(--border-subtle)' }}>
                                <div><span style={{fontSize: '0.7rem', color: 'var(--text-muted)'}}>STR</span><input type="number" className="input" value={editingHero.template.baseStr} onChange={e => setEditingHero({...editingHero, template: {...editingHero.template, baseStr: parseInt(e.target.value) || 0}})} /></div>
                                <div><span style={{fontSize: '0.7rem', color: 'var(--text-muted)'}}>DEX</span><input type="number" className="input" value={editingHero.template.baseDex} onChange={e => setEditingHero({...editingHero, template: {...editingHero.template, baseDex: parseInt(e.target.value) || 0}})} /></div>
                                <div><span style={{fontSize: '0.7rem', color: 'var(--text-muted)'}}>CON</span><input type="number" className="input" value={editingHero.template.baseCon} onChange={e => setEditingHero({...editingHero, template: {...editingHero.template, baseCon: parseInt(e.target.value) || 0}})} /></div>
                                <div><span style={{fontSize: '0.7rem', color: 'var(--text-muted)'}}>INT</span><input type="number" className="input" value={editingHero.template.baseInt} onChange={e => setEditingHero({...editingHero, template: {...editingHero.template, baseInt: parseInt(e.target.value) || 0}})} /></div>
                                <div><span style={{fontSize: '0.7rem', color: 'var(--text-muted)'}}>WIS</span><input type="number" className="input" value={editingHero.template.baseWis} onChange={e => setEditingHero({...editingHero, template: {...editingHero.template, baseWis: parseInt(e.target.value) || 0}})} /></div>
                                <div><span style={{fontSize: '0.7rem', color: 'var(--text-muted)'}}>CHA</span><input type="number" className="input" value={editingHero.template.baseCha} onChange={e => setEditingHero({...editingHero, template: {...editingHero.template, baseCha: parseInt(e.target.value) || 0}})} /></div>
                            </div>
