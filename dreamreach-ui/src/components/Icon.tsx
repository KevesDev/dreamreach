...
interface IconProps {
    name: 'population' | 'food' | 'wood' | 'stone' | 'gold' | 'gems' | 'logout' | 'home' | 'combat' | 'summon';
    size?: number;
    className?: string;
...
const paths = {
    ...
    combat: "M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z", // Shield silhouette
    summon: "M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z", // Sharp star
